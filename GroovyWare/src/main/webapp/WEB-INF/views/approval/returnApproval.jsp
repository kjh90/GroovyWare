											...
											<tbody>
												<c:if test="${requestScope.a_list ne null }">
													<c:forEach items="${requestScope.a_list }" var="avo">
														<tr class="rgRow" style="white-space: nowrap;">
															<td class="col_ct">
																<span href="#view_draft" class="btn_update" style="font-weight:bold !important;">
																	${avo.dvo.draft_code }
												...
												<c:if test="${requestScope.a_list eq null }">
													<tr class="rgNoRecords ">
														<td colspan="5" class="col_ct search_none">결재반려받은 문서가 없습니다.</td>
													</tr>
												</c:if>
											</tbody>
